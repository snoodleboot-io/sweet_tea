...
"""
Inverter factory implementation for returning class definitions instead of instances.

This factory puts the control of instantiation in the user's hands by returning
the class definition rather than creating an instance. Useful for lazy construction
patterns where instantiation should be deferred or controlled by the caller.
"""
